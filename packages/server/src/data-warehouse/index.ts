...
export type { DatabaseConfigOptions } from './config';
...
export type { ExportOptions, ManagedIcebergAttachOptions, WarehouseSourceTable } from './export';

export { getSyncAction, syncData } from './sync';
export type { SyncAction, SyncDatabaseConnectionOptions, SyncOptions, SyncResourceResult, SyncResult } from './sync';
